  ...
  return (
    <div className="flex flex-col rounded-xl shadow-md">
      ...
      <div className="bg-white rounded-b-xl p-5">
        ...
        <div className='bg-black py-3 rounded-xl mt-2.5 flex flex-row gap-2 items-center justify-center text-white hover:cursor-pointer hover:bg-gray-700 active:bg-gray-600 transition-colors duration-300'>
          Check it out
